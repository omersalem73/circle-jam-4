...
class PopupMessage(VisibilityToggle):
    ...
    def __init__(self):
        ...
        self._text_box = TextBox('-- New Contestant --\nName: Omer Salem\nChance of answering easy questions: 0.5\nChance of answering average questions: 0.5\nChance of answering hard questions: 0.5\nChance of contestant withdrawal: 0.5\n\nTotal profit +/- this round: +30000\nTotal rating +/- this round: +2.75', SCREEN_WIDTH / 2 - 20,
